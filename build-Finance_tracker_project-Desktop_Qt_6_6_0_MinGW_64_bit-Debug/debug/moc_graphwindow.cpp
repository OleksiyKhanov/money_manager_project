...
#include "../../Finance_tracker_project/graphwindow.h"
...
static constexpr auto qt_meta_stringdata_CLASSGraphWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "data",
    "on_comboBox_choseFinAcc_activated",
    "index",
    "setGraph"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphWindowENDCLASS_t qt_meta_stringdata_CLASSGraphWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 8),  // "getGraph"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 13),  // "Graph<float>&"
        QT_MOC_LITERAL(36, 1),  // "a"
        QT_MOC_LITERAL(38, 10),  // "setAccList"
        QT_MOC_LITERAL(49, 22),  // "QList<FinanceAccount>&"
        QT_MOC_LITERAL(72, 4),  // "data"
        QT_MOC_LITERAL(77, 33),  // "on_comboBox_choseFinAcc_activ..."
        QT_MOC_LITERAL(111, 5),  // "index"
        QT_MOC_LITERAL(117, 8)   // "setGraph"
    },
    "GraphWindow",
    "getGraph",
    "",
...
Q_CONSTINIT const QMetaObject GraphWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGraphWindowENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<Graph<float> &, std::false_type>,
        // method 'setAccList'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QVector<FinanceAccount> &, std::false_type>,
        // method 'on_comboBox_choseFinAcc_activated'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void GraphWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->getGraph((*reinterpret_cast< std::add_pointer_t<Graph<float>&>>(_a[1]))); break;
        case 1: _t->setAccList((*reinterpret_cast< std::add_pointer_t<QList<FinanceAccount>&>>(_a[1]))); break;
        case 2: _t->on_comboBox_choseFinAcc_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->setGraph((*reinterpret_cast< std::add_pointer_t<Graph<float>&>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GraphWindow::*)(Graph<float> & );
            if (_t _q_method = &GraphWindow::getGraph; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphWindow::getGraph(Graph<float> & _t1)
{
